...
\cvitem{}{[1] Degradation-Aware LiDAR-Thermal-Inertial SLAM. IEEE Robotics and Automation Letters(RA-L). (Under Review, \textbf{Co-First Author}) Y. Wang*, \textbf{Y. Liu*}, L. Chen, H. Chen, and S. Zhang.}
\cvitem{}{[2] Edge-based Monocular Thermal-Inertial Odometry in Visually Degraded Environments. IEEE Robotics and Automation Letters(RA-L), 8(4):2078-2085, 2023. Y. Wang, H. Chen, \textbf{Y. Liu}, and S. Zhang.  \href{https://ieeexplore.ieee.org/document/10048516}{[link]} }



\section{Research Experiences}

\cventry{Oct.2021-Jun.2024}{}{Thermal Camera Centered Multi Sensor SLAM in Challenging Environments}{\href{https://www.nrs-lab.com/}{nROS-Lab},HITsz}{}%
{
\begin{itemize}%
...
\item Developed a simulation system in Ignition Gazebo for SLAM in complex extreme environments.
...
\end{itemize}
\item Proposed a Degradation-Aware LiDAR-Thermal-Inertial SLAM \hyperref[sec:Publications]{[publication]}.
\begin{itemize}%
...
\begin{itemize}%
    ...
    \item Third Prize of China Undergraduate Mathematical Contest in Modelling\hfill 2021
...
\begin{itemize}%
    ...
    \item Developed visual-inertial odometry and planning in underwater environments.
